...
class Family
{
    ...
    public function getPseudoFamily(): ?string
    {
        return $this->pseudo_family;
    }

    public function setPseudoFamily(string $pseudo_family): self
    {
        $this->pseudo_family = $pseudo_family;
